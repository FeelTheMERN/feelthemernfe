    ...
    <form>
      ...
      <div>
        <div className="radio-input">
          ...
          <input className="radio" type="radio" id="gender" name="gender" value="male" onClick={props.handleInputChange}/>
        </div>
        <div className="radio-input">
          <label htmlFor="gender">Female</label>
          <input className="radio" type="radio" id="gender" name="gender" value="female" onClick={props.handleInputChange}/>
        </div>                
      </div>
    </form>
  )
